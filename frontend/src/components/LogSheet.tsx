...
export function LogSheet({ day, header, index, count }: { day: LogDay; header: TripHeader; index: number; count: number }) {
    ...
    <div className="overflow-x-auto rounded-lg border border-border bg-white">
      ...
      >
        ...
        {headerField(
          ...
          20,
          'Tractor / trailer no.',
          [header.tractor_number, header.trailer_number].filter(Boolean).join(' / ') || '—',
        )}
        ...
        {day.remarks.map((rm, k) => {
          ...
          return (
            <g key={k}>
              ...
              <text x={x + 3} y={yTop + 26} fontSize="7.5" fill="#333" transform={`rotate(55 ${x + 3} ${yTop + 26})`}>
