...
const ENDPOINT = 'https://photon.komoot.io/api/?limit=6&lang=en&lat=39.8&lon=-98.6&q='; // Bias toward the US (geographic centroid) without hard-filtering.
        ...
        >
          {items.map((s, i) => (
            <li
              ...
              className={cn('cursor-pointer px-3 py-1.5', i === active && 'bg-accent text-accent-foreground')}
            >
